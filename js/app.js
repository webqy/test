(() => {
    ...
    function initSliders() {
        if (document.querySelector(".lineup__slider")) new core(".lineup__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".periphery__slider")) new core(".periphery__slider", {
            modules: [ freeMode ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
 ...
 */
    ...
    const videoGenerate = video => {
        const btn = video.querySelector(".live-swiper-desktop__button");
        const videoID = btn.dataset.videoId;
        const container = video.querySelector(".live-swiper-desktop__video-item");
    ...
    videoInit(".live-swiper-desktop__video");
    window["FLS"] = true;
    isWebp();
    menuInit();
})();